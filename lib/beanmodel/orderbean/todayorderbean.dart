...
class TodayOrderMain{
  ...
  factory TodayOrderMain.fromJson(dynamic json){
    ...
    return TodayOrderMain(json['user_address'], json['cart_id'], json['user_name'], json['user_phone'], json['remaining_price'], json['order_price'], json['delivery_boy_name'],
        json['delivery_boy_phone'], json['delivery_date'], json['time_slot'], json['payment_mode'], json['payment_status'],
        json['order_status'], json['customer_phone'], order_d);
  }
}
