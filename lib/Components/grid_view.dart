...
GridView buildGridView(List<StoreProductData> listName,
    {bool favourites = false, void callBack(int index, String type),void update(StoreProductData pdData, String type, int pvid), void addVaraient(int pid),void updateStock(StoreProductData pdData, String type, int varientId)}) {
...
GridView buildGridAdminView(List<StoreProductM> listName,
    {bool favourites = false, void callBack(int index, String type),void update(StoreProductM pdData, String type, int pvid), void addVaraient(int pid)}) {
  return GridView.builder(
      padding: EdgeInsets.all(20.0),
      physics: BouncingScrollPhysics(),
      shrinkWrap: true,
                                              ...
                                              children: [
                                                GestureDetector(
                                                  onTap: () {
                                                    ...
                                                    update(
                                                        productData,
                                                        'variant',int.parse('${productData.varients[index].varientId}'));
                                                  },
                                                  behavior:
...
Widget buildProductAdminCard(
  BuildContext context,
  StoreProductM productData, {
