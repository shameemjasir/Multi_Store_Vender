        ...
        body: SafeArea(
          child: SingleChildScrollView(
            child: Column(
              children: [
                AppBar(
                  title: Text('${locale.orderinfo} - (#${productDetails.cart_id})',style: TextStyle(fontSize: 15),),
                  actions: [
                    Visibility(
                      ...
                      child: Padding(
                        ...
                        child: MaterialButton(
                          ...
                          child: Text(locale.cancelOrdr,style: TextStyle(color: kWhiteColor, fontSize: 12),),
                        ),
                      ),
                    )
                  ],
                            ...
                            children: [
                              Container(
                                ...
                                child: ClipRRect(
                                    borderRadius: BorderRadius.circular(5),
                                    child: Image.network(
                                        '${productDetails.order_details[index].varient_image}',
                                        fit: BoxFit.cover)),
                              ),
                              SizedBox(
                                width: 10,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Text(
                                            '${locale.invoice3h} - $apCurrency ${productDetails.order_details[index].price}',
                                            style: TextStyle(
                                              fontSize: 13,
                                              color: kWhiteColor,
                                            ),
                                          ...
                                          Text(
                                            '${locale.invoice4h} ${locale.invoice3h} - $apCurrency ${(double.parse('${productDetails.order_details[index].price}') * double.parse('${productDetails.order_details[index].qty}'))}',
                                            style: TextStyle(
                                              fontSize: 13,
                                              color: kWhiteColor,
                                            ),
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Text(locale.orderedOn + ' ${productDetails.order_details[0].order_date}',
                                style: Theme.of(context)
                                    .textTheme
                                    .subtitle2
                                    .copyWith(fontSize: 13)),
                            Spacer(),
                            Text(locale.orderID + ' #${productDetails.cart_id}',
                      ...
                      Padding(
                        padding: const EdgeInsets.symmetric(vertical: 10.0),
                        child: Text(locale.deliveryDate + ' ${productDetails.delivery_date} ${productDetails.time_slot} ',
                            style: Theme.of(context)
                                .textTheme
                                .subtitle2
                                .copyWith(fontSize: 13)),
                        ...
                        children: [
                          RichText(
                            text: TextSpan(
                              ...
                              children: <TextSpan>[
                                TextSpan(
                                    text: '$apCurrency ${productDetails.order_price}',
                                    style: TextStyle(
                          ...
                          RichText(
                            text: TextSpan(
                              ...
                              children: <TextSpan>[
                                TextSpan(
                                    text: '${productDetails.order_details.length} items',
                                    style: TextStyle(
                                        color: Theme.of(context).backgroundColor,
                                        fontWeight: FontWeight.w500)),
                              ],
                                ...
                                RichText(
                                  text: TextSpan(
                                    ...
                                    children: <TextSpan>[
                                      TextSpan(
                                          text:
                                          '${productDetails.delivery_boy_phone}',
                                          style: Theme.of(context)
                                              .textTheme
                                              .bodyText2
                      ...
                      RichText(
                        text: TextSpan(
                          ...
                          children: <TextSpan>[
                            TextSpan(
                                text:
                                '${productDetails.user_address}\n\n',
                                style: Theme.of(context)
                                    .textTheme
                                    .bodyText2
                                    .copyWith(fontSize: 15)),
                            TextSpan(
                                text: '${productDetails.user_phone}',
                                style: Theme.of(context)
                                    .textTheme
                                    .bodyText2
                                    .copyWith(fontSize: 15)),
