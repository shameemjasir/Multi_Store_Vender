            ...
            child: Column(
              ...
              children: [
                ...
                buildListTile(context, Icons.insert_chart, locale.insight,
                    PageRoutes.insight),
                buildListTile(context, Icons.assignment_returned,
                    locale.myItems, PageRoutes.myItemsPage),
                ...
                buildListTile(context, Icons.view_list, locale.aboutUs,
                    PageRoutes.aboutus),
                buildListTile(context, Icons.admin_panel_settings_rounded,
                    locale.tnc, PageRoutes.tnc),
                buildListTile(context, Icons.chat, locale.helpCentre,
